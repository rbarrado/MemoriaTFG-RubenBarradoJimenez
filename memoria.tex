...
\vspace{5mm}
Con el servidor arrancado, una vez se completa el despligue, en la consola deberá aparecer el mensaje que se ve en la Figura~\ref{fig:started}.
\begin{figure}[h]
  \centering
